...
STRING_LITERAL(TMP223, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP216 = mulInt64((*b), IL64(10));
				TMP217 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP218 = subInt64((NI64)(TMP216), ((NI64) ((NI)(TMP217))));
				(*b) = (NI64)(TMP218);
		...
		TMP221 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP221);
		TMP222 = subInt(i, start);
		result = (NI)(TMP222);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_95055 = 0;
		e_95055 = (Overflowerror3443*) newObj((&NTI23401), sizeof(Overflowerror3443));
		(*e_95055).Sup.Sup.Sup.m_type = (&NTI3443);
		LOC9 = 0;
		LOC9 = (*e_95055).Sup.Sup.message; (*e_95055).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP223));
