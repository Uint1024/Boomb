...
#include <stdlib.h>
typedef struct Runningstat112847 Runningstat112847;
struct  Runningstat112847  {
NI n;
NF sum;
NF min;
NF max;
...
N_NIMCALL(NU8, classify_111226)(NF x);
N_NIMCALL(NI, binom_111242)(NI n, NI k);
N_NIMCALL(NI, fac_111282)(NI n);
N_NIMCALL(NIM_BOOL, ispoweroftwo_111321)(NI x);
N_NIMCALL(NI, nextpoweroftwo_111331)(NI x);
N_NIMCALL(NI, countbits32_111825)(NI32 n);
N_NIMCALL(NF, sum_111891)(NF* x, NI xLen0);
N_NIMCALL(NF, mean_111885)(NF* x, NI xLen0);
N_NIMCALL(NF, variance_111963)(NF* x, NI xLen0);
N_NIMCALL(NF, log2_112047)(NF x);
N_NIMCALL(NF, random_112018)(NF max);
N_NIMCALL(void, randomize_112024)(void);
N_NIMCALL(void, randomize_112029)(NI seed);
N_NIMCALL(NF, ntepochTime)(void);
N_NIMCALL(NI, random_112012)(NI max);
N_NIMCALL(NF, mod_112807)(NF x, NF y);
N_NIMCALL(void, push_112864)(Runningstat112847* s, NF x);
N_NIMCALL(void, push_112885)(Runningstat112847* s, NI x);
N_NIMCALL(NF, variance_112896)(Runningstat112847* s);
N_NIMCALL(NF, standarddeviation_112906)(Runningstat112847* s);
...
{	result = 0;
	...
	result = n;
	{
		...
		{
			while (1) {
				if (!(res_111263 <= k)) goto LA11;
				i_111259 = res_111263;
				result = (NI)((NI)(result * (NI)((NI)(n + ((NI) 1)) - i_111259)) / i_111259);
				res_111263 += ((NI) 1);
			} LA11: ;
		}
	}
...
N_NIMCALL(NI, fac_111282)(NI n) {
	...
	result = ((NI) 1);
	{
		...
		{
			while (1) {
				if (!(res_111302 <= n)) goto LA3;
				i_111298 = res_111302;
				result = (NI)(result * i_111298);
				res_111302 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(NF, sum_111891)(NF* x, NI xLen0) {
	...
	result = 0;
	{
		...
		{
			while (1) {
				if (!(i_111937 < xLen0)) goto LA3;
				i_111933 = x[i_111937];
				result = ((NF)(result) + (NF)(i_111933));
				i_111937 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(NF, variance_111963)(NF* x, NI xLen0) {
	...
	m = mean_111885(x, xLen0);
	{
		...
		i_111980 = 0;
		HEX3Atmp_111990 = 0;
		HEX3Atmp_111990 = (xLen0-1);
		res_111993 = ((NI) 0);
		{
			while (1) {
				NF diff;
				if (!(res_111993 <= HEX3Atmp_111990)) goto LA3;
				i_111980 = res_111993;
				diff = ((NF)(x[i_111980]) - (NF)(m));
