...
TNimType NTI152019; /* Player:ObjectType */
TNimType NTI152018; /* Player */
extern TFrame* frameptr_17042;
extern Tgcheap48616 gch_48644;
N_NIMCALL(void, TMP367)(void* p, NI op) {
	PlayerHEX3Aobjecttype152019* a;
	a = (PlayerHEX3Aobjecttype152019*)p;
...
N_NIMCALL(PlayerHEX3Aobjecttype152019*, newplayer_152024)(NI32 x, NI32 y) {
	PlayerHEX3Aobjecttype152019* result;
	PlayerHEX3Aobjecttype152019* LOC1;
	VisiblenormalHEX3Aobjecttype146061* LOC2;
	CollidablenormalHEX3Aobjecttype147021* LOC3;
	UpdatableplayerHEX3Aobjecttype148023* LOC4;
	nimfr("newPlayer", "player.nim")
	result = 0;
	nimln(14, "player.nim");
	LOC1 = 0;
	LOC1 = (PlayerHEX3Aobjecttype152019*) newObj((&NTI152018), sizeof(PlayerHEX3Aobjecttype152019));
	(*LOC1).Sup.Sup.m_type = (&NTI152019);
	LOC2 = 0;
	LOC2 = newvisiblenormal_146068(x, y, ((NI32) 30), ((NI32) 30), ((NU8) 0));
	asgnRef((void**) (&(*LOC1).Sup.visible), &LOC2->Sup);
	nimln(15, "player.nim");
	LOC3 = 0;
	LOC3 = newcollidablenormal_147028(x, y, ((NI32) 30), ((NI32) 30));
	asgnRef((void**) (&(*LOC1).Sup.collidable), &LOC3->Sup);
	nimln(16, "player.nim");
	LOC4 = 0;
	LOC4 = newupdatableplayer_148031();
	asgnRef((void**) (&(*LOC1).Sup.updatable), &LOC4->Sup);
	result = LOC1;
	popFrame();
	return result;
}
NIM_EXTERNC N_NOINLINE(void, HEX00_playerInit)(void) {
	nimfr("player", "player.nim")
	popFrame();
}

NIM_EXTERNC N_NOINLINE(void, HEX00_playerDatInit)(void) {
static TNimNode TMP365[1];
NTI152019.size = sizeof(PlayerHEX3Aobjecttype152019);
NTI152019.kind = 17;
NTI152019.base = (&NTI149007);
TMP365[0].len = 0; TMP365[0].kind = 2;
NTI152019.node = &TMP365[0];
NTI152018.size = sizeof(PlayerHEX3Aobjecttype152019*);
NTI152018.kind = 22;
NTI152018.base = (&NTI152019);
NTI152018.marker = TMP367;
}
